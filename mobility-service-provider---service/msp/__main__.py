...
from msp.app import DefaultService
from msp.config import AppConfig
...
class GunicornApp(BaseApplication):
    ...
    def load_config(self):
        ...
        self.cfg.set('worker_class', 'msp.__main__.CustomWorker')
...
def main():
    ...
    if args.qa:
        conf_file = './etc/msp/QA.yml'
    else:
        conf_file = './etc/msp/dev.yml'
